...
export default async function DashboardPage(){
  ...
  return <GoogleAdsFrame user={user}><div className="ga-page-head"><div><p>DAVID AGENCY MCC MANAGER</p><h1>Dashboard</h1><span>Dữ liệu hợp nhất từ các Google account đã kết nối.</span></div>{user.role==='ADMIN'&&config.configured&&<a className="ga-primary" href="/api/auth/google-ads">Đăng nhập Google Ads</a>}</div>
